-- Script to fix the periodic_table database

-- Start by dropping the database and creating a fresh one
-- DROP DATABASE IF EXISTS periodic_table;
-- CREATE DATABASE periodic_table
--     WITH TEMPLATE periodic_table_orig OWNER freecodecamp;
...
INSERT INTO elements(atomic_number, symbol, name) VALUES
    (9, 'F', 'Fluorine'),
    (10, 'Ne', 'Neon');
INSERT INTO properties(atomic_number, weight, melting_point, boiling_point, type) VALUES
